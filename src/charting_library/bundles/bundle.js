!function(e, s) {
    ...
    class t {
        ...
        getBars(e, t, r) {
            ...
            return void 0 !== r.countBack && (i.countback = r.countBack),
        ...
        async _processTruncatedResponse(e, t) {
            ...
            try {
                for (; this._limitedServerResponse && this._limitedServerResponse.maxResponseLength > 0 && this._limitedServerResponse.maxResponseLength === r && t.from < t.to; ) {
                    ...
                    r = i.bars.length,
                    "earliestFirst" === this._limitedServerResponse.expectedOrder ? e.bars.push(...i.bars) : e.bars.unshift(...i.bars)
                }
            } catch (e) {
                if (e instanceof Error || "string" == typeof e) {
                    const t = s(e);
            ...
            if (!(this._requestsPending > 0))
                for (const t in this._subscribers) {
                    ...
                    this._quotesProvider.getQuotes(1 === e ? r.fastSymbols : r.symbols).then((e=>{
                        this._requestsPending--,
                        this._subscribers.hasOwnProperty(t) && (r.listener(e),
                        this._requestsPending)
                    }
                    )).catch((e=>{
                        this._requestsPending--,
    ...
    class a {
        ...
        _init() {
            ...
            for (const t of this._exchangesList)
                s[t] || (s[t] = !0,
                e.push(this._requestExchangeData(t)));
        ...
        _onExchangeDataReceived(e, s) {
            ...
            try {
                ...
                for (; t < e; ++t) {
                    ...
                    void 0 === c && void 0 === h || (this._symbolsInfo[n(d, c, h)] = _,
    ...
    class c {
        ...
        resolveSymbol(e, t, r, i) {
            ...
            if (this._configuration.supports_group_request) {
                ...
                this._send("symbols", t).then((e=>{
                    var s, t, i, o, n, l, u, c, h, d, _, m, p, y, b, f, g, v, P, q, w, S, x, R, k, I, D, T, B;
                    if (void 0 !== e.s)
                        r("unknown_symbol");
                    else {
                        const r = e.name
                          ...
                          , E = null !== (i = e.full_name) && void 0 !== i ? i : `${C}:${r}`;
                        a({
                            ...e,
                            name: r,
                            base_name: [U + ":" + r],
                            ...
                            minmov: null !== (y = null !== (p = e.minmovement) && void 0 !== p ? p : e.minmov) && void 0 !== y ? y : 0,
                            minmove2: null !== (f = null !== (b = e.minmovement2) && void 0 !== b ? b : e.minmove2) && void 0 !== f ? f : e.minmov2,
                            session: null !== (g = e.session) && void 0 !== g ? g : e["session-regular"],
                            ...
                            has_empty_bars: null !== (D = e.has_empty_bars) && void 0 !== D ? D : e["has-empty-bars"],
                            volume_precision: null !== (T = e.volume_precision) && void 0 !== T ? T : e["volume-precision"],
        ...
        _requestConfiguration() {
            return this._send("config").catch((e=>(s(e),
            null)))
        }
        _send(e, s) {
        ...
        _setupWithConfiguration(e) {
            ...
            !e.supports_group_request && e.supports_search || (this._symbolsStorage = new a(this._datafeedURL,e.supported_resolutions || [],this._requester)),
            JSON.stringify(e)
        }
    }
    class h {
    ...
    class d {
        ...
        sendRequest(e, s, t) {
            ...
            return void 0 !== this._headers && (r.headers = this._headers),
            fetch(`${e}/${s}`, r).then((e=>e.text())).then((e=>JSON.parse(e)))
        }
    }
