(self.webpackChunktradingview = self.webpackChunktradingview || []).push([[1075], {
    9790: e=>{
        e.exports = {
        ...
        function u(e) {
            ...
            if (e && 1 == ++l) {
                const e = o(t, "overflow")
                  , l = r(t, "padding-right");
                "hidden" !== e.toLowerCase() && t.scrollHeight > t.offsetHeight && (i(n, "right", `${s()}px`),
                t.style.paddingRight = `${l + s()}px`,
                a = !0),
                t.classList.add("i-no-scroll")
            } else if (!e && l > 0 && 0 == --l && (t.classList.remove("i-no-scroll"),
            a)) {
                i(n, "right", "0px");
                let e = 0;
                0,
    ...
    58095: (e,t,n)=>{
        ...
        var s = n(50959)
          , i = n(39640);
        function o(e) {
            const {click: t, mouseDown: n, touchEnd: o, touchStart: r, handler: l, reference: a, ownerDocument: u=document} = e
              , c = (0,
            s.useRef)(null)
              , d = (0,
            s.useRef)(new CustomEvent("timestamp").timeStamp);
            return (0,
            s.useLayoutEffect)((()=>{
                const e = {
                    click: t,
                ...
                return (0,
                i.addOutsideEventListener)(d.current, s, l, u, e)
            }
            ), [t, n, o, r, l]),
            a || c
        }
    ...
    27317: (e,t,n)=>{
        ...
        class v extends s.PureComponent {
            constructor(e) {
                ...
                this._handleMeasure = ({callback: e, forceRecalcPosition: t}={})=>{
                    ...
                    const {position: _} = this.props
                      , v = (0,
                    r.ensureNotNull)(this._containerRef);
                    ...
                    if (b) {
                        (0,
                        r.ensureNotNull)(this._scrollWrapRef).style.overflowY = "scroll",
                        g = v.getBoundingClientRect()
                    }
                    const {width: W, height: M} = g
                      , S = "function" == typeof _ ? _(W, M, y) : _
                      , E = null !== (i = null === (s = null == S ? void 0 : S.indentFromWindow) || void 0 === s ? void 0 : s.left) && void 0 !== i ? i : 0
                      , R = C - (null !== (o = S.overrideWidth) && void 0 !== o ? o : W) - (null !== (u = null === (a = null == S ? void 0 : S.indentFromWindow) || void 0 === a ? void 0 : a.right) && void 0 !== u ? u : 0)
                      , O = (0,
                    l.clamp)(S.x, E, Math.max(E, R))
                      , N = (null !== (d = null === (c = null == S ? void 0 : S.indentFromWindow) || void 0 === c ? void 0 : c.top) && void 0 !== d ? d : 0) + x
                      , T = y - (null !== (h = S.overrideHeight) && void 0 !== h ? h : M) - (null !== (m = null === (p = null == S ? void 0 : S.indentFromWindow) || void 0 === p ? void 0 : p.bottom) && void 0 !== m ? m : 0);
                    let P = (0,
                    l.clamp)(S.y, N, Math.max(N, T));
                    if (S.forbidCorrectYCoord && P < S.y && (w -= S.y - P,
                    P = S.y),
                    t && void 0 !== this.props.closeOnScrollOutsideOffset && S.y <= this.props.closeOnScrollOutsideOffset)
                        return void this._handleGlobalClose(!0);
                    const D = null !== (f = S.overrideHeight) && void 0 !== f ? f : b ? w : void 0;
                    this.setState({
                ...
                this._restoreScrollPosition = ()=>{
                    ...
                    if (null !== e && t.contains(e))
                        ...
                        (0,
                        r.ensureNotNull)(this._scrollWrapRef).scrollTop = this._scroll
                }
                ,
                this._resizeForced = ()=>{
                    this.setState({
                ...
                this._handleScroll = ()=>{
                    this._scroll = (0,
                    r.ensureNotNull)(this._scrollWrapRef).scrollTop
                }
                ,
            ...
            render() {
                const {id: e, role: t, "aria-label": n, "aria-labelledby": i, "aria-activedescendant": r, "aria-hidden": l, children: c, minWidth: d, theme: h=f, className: _, maxHeight: v, onMouseOver: y, onMouseOut: C, onKeyDown: x, onFocus: w, onBlur: b} = this.props
                  , {appearingMenuHeight: W, appearingMenuWidth: M, appearingPosition: S, isMeasureValid: E} = this.state;
        ...
        function g(e) {
            const t = (0,
            r.ensureNotNull)((0,
            s.useContext)(p.SubmenuContext))
              , n = s.useRef(null);
            return s.createElement("div", {
                ref: n,
                className: e.className,
                onMouseOver: function(e) {
                    if (!(null !== t.current && e.target instanceof Node && (s = e.target,
    ...
    88216: (e,t,n)=>{
        ...
        class o {
            ...
            ensureWindow(e, t={
                ...
                if (s.style.position = t.position,
    ...
    65718: (e,t,n)=>{
        ...
        class a extends s.PureComponent {
            ...
            render() {
                ...
                i.createPortal(s.createElement(u.Provider, {
                    value: this
            ...
            _manager() {
                ...
                r.getRootOverlapManager)() : this.context
            }
        }
