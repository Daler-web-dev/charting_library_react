const TradingView = function(t) {
    ...
    function e(t, n) {
        ...
        for (const o in n)
            "object" != typeof t[o] || null === t[o] || Array.isArray(t[o]) ? void 0 !== n[o] && (i[o] = n[o]) : i[o] = e(t[o], n[o]);
        return i
    }
    const n = {
        width: 800,
    ...
    function s(t, e) {
        const n = new URL(`${t || ""}`,location.href).href
          , i = JSON.parse('["bundles/runtime.07b91e827a9e2e00f3e6.js","bundles/__LANG__.8113.6effbc8b6375d6a16597.js","bundles/7717.8f75bd75d4b6ed45f3ff.css","bundles/7717.8f75bd75d4b6ed45f3ff.rtl.css","bundles/4618.1f26befe6bcf2274cd1a.js","bundles/library.37165260d08a007f8938.js","bundles/EuclidCircular.be8f862db48c2976009f.woff2"]')
          ...
          , l = `\n${function(t, e, n) {
            ...
            const i = []
              ...
              , d = /\.rtl\.css$/i;
            for (const l of t)
                l.endsWith(".js") ? s.push(`<script defer crossorigin="anonymous" src="${l.replace("__LANG__", n)}"><\/script>`) : a.test(l) && e === d.test(l) ? r.push(`<link type="text/css" href="${l}" rel="stylesheet"/>`) : /\.woff\d*/.test(l) && i.push(o(l));
            return [...i, ...s, ...r].join("\n")
        }(i, "rtl" === a.dir, r)}\n`;
    ...
    const a = class {
        constructor(t) {
            ...
            (null === (o = t.overrides) || void 0 === o ? void 0 : o["mainSeriesProperties.priceAxisProperties.lockScale"]) && (console.warn("mainSeriesProperties.priceAxisProperties.lockScale can not be set to true within the widget constructor"),
            ...
            this._options.debug && (i || (i = !0,
            console.log("Using CL v24.000 (internal id b7d8dd93 @ 2023-02-14T12:17:58.891Z)"))),
            this._create()
        }
        setDebugMode(t) {
        ...
        _create() {
            ...
            n.innerHTML = t,
            this._iFrame = n.querySelector(`#${this._id}`);
